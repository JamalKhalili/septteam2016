...
class phpDocumentor_setup
{
    ...
    function readConfigFile($file)
    {
        ...
        {
            if ('/Users/jamal/pear/data' != '@'.'DATA-DIR@')
            {
                $configdir = str_replace('\\','/', '/Users/jamal/pear/data/PhpDocumentor') . PATH_DELIMITER . 'user' . PATH_DELIMITER;
            } else {
    ...
    function parseIni()
    {
        ...
        if ('/Users/jamal/pear/data' != '@'.'DATA-DIR@')
        {
            $options = phpDocumentor_parse_ini_file(str_replace('\\','/', '/Users/jamal/pear/data/PhpDocumentor') . PATH_DELIMITER . 'phpDocumentor.ini',true);
            phpDocumentor_out("   (found in " . '/Users/jamal/pear/data/PhpDocumentor' . PATH_DELIMITER . ")...\n");
        } else {
